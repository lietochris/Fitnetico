  ...
  <q-Layout>
    ...
    <div class="img-header">
      <div class="welcome">
        ...
        <q-btn to="/registro" color="purple" rounded label="Registrarse"/>
      </div>
    </div>
          ...
          <div class="formulario-content">
            <form id="formulario">
              ...
              <div class="mensaje-form">
                <p>Escribenos un mensaje, con gusto tendras una respuesta de parte de nosotros en muy poco tiempo. ATT:
                  Fitneticos</p>
              </div>
            </form>
          </div>
