        ...
        <div class="tw-flex tw-mb-4">
          <div class="tw-w-full">
            <div class="tw-flex tw-flex-row tw-flex-wrap tw-px-5 tw-mb-5">
              <div v-for="i in 9" :key="i" class="tw-w-3/6 tw-p-3 ">
                      ...
                      <div class="tw-w-full bg-grey-4" style="border-radius: 15px">
                        <div class="tw-flex tw-flex-row">
                          <div class="tw-flex tw-justify-center tw-p-6">
                            <img src="https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/3-weighted-pushup-1495476721.jpg?crop=1xw:1xh;center,top&resize=320:*" class="responsive" width="160" height="30">
                          </div>
                          <div class="tw-flex-col">
                            ...
                            <div class="tw-flex tw-flex-row">
                              <p class="tw-pt-2 tw-px-2 text-black tw-text-lg tw-break-words tw-font-mono text-weight-bolder">
                                Equipo:
                              </p>
                            ...
                            <div class="tw-flex tw-flex-row">
                              <q-rating v-model="ratingModel" size="2em" color="grey" :max="4" readonly class="tw-px-2" :color-selected="ratingColors">
