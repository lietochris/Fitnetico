  ...
  <div class="tw-py-12">
    <div class="flex tw-mb-4">
      <div class="tw-w-full" style="height:350px">
        ...
        <q-img style="height:350px"  class="tw-h-full" src="https://www.cmdsport.com/app/uploads/2019/05/imagym-huesca.jpg" >
          <div class="absolute-full text-subtitle2 flex flex-center">
            <div class="text-h3 text-white "> Mis rutinas &nbsp;  
            </div>
          </div>
        </q-img>
        </div>
   ...
   <div class="flex tw-mb-4 tw-px-6">
      <div class="tw-w-full tw-h-40 recent">
        ...
        <p class="tw-pl-8 tw-pt-4 text-white tw-text-md "> <span>objetivo: xxxxx </span> <span class="tw-pr-8" style="float:right;"> Dificultad: xxxxx </span> </p>
   ...
   <div class="flex tw-mb-4">
      ...
      <router-link :to="'/rutinas/ver/rutina' + i">
        ...
        <p class="tw-pl-8 tw-pt-4 text-white tw-text-md tw-break-words"> <span>objetivo: xxxxx </span> <span class="tw-pr-8" style="float:right;"> Dificultad: xxxxx </span> </p>
        <div class="tw-h-8 bg-dark"></div>
      </div>
    </div>
     </router-link>
